...
0. Introduction and basic ouline.
...
** certain nuisanes to consider 
** thresholding and filters.  What is acceptable?
* The size of modern data sets (TCGA) and their current applications, e.g. in healthcare
** What is the future of NGS? 
* What does a standard genome look like and how it informs the analysis. 
** differences in germline vs somatic mutations and how this is crucial for studying cancer. 

2. Basic vocabulary and concepts. 
 
* Classes of somatic mutations
* The differences between synonymous vs nonsynonymous mutations
...
Here we will summarize and talk about pratracaililty of the analysis.  There will also be some "homework" or extra take home exercises.
...
# lets figure out what type of mutations are often seen in BRCA
...
# ok lets seperate out germ line vs somatic.
...
# lets now red frequency table by subsetting various levels pathogneicty
