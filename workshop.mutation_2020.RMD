...
# think of this as a cheat code designed for this workshop. 
...
# ? how do you think we can use this to look for our dataset amoung > 200 studies?
...
# from the table we now know that the study id:  brca_tcga_pub2015 
...
### BONUS check if your favorite gene(s)
...
# As mentioned previously one reliable way to look for relevant mutations is to match it against what has been previosly observed and/or study. Here we can try to use Cosmic however other organization may be relevant as well including clinvar
...
# HERE you is where the fun is! The discovery part.  And there are many many ways to do this.  
# so be creative! 
...
ggplot(g1, aes(y=value, x=HER2p, fill=HER2p)) +
        ...
        theme(legend.position="bottom", legend.title=element_blank(), legend.key = element_blank(),
              ...
              legend.text      =element_text(size=12)
                         ...
                         geom = "crossbar", width = .5) + ggtitle ( "TP53")
